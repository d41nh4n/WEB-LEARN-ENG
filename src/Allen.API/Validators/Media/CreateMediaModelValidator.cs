...
public class CreateMediaModelValidator : AbstractValidator<CreateMediaModel>
{
    public CreateMediaModelValidator()
    {
        ...
        RuleFor(x => x.Transcripts)
            ...
            .ForEach(q => q.SetValidator(new CreateTranscriptModelValidator()));
    }
}
