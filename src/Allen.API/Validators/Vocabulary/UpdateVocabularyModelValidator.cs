...
public class UpdateVocabularyModelValidator : AbstractValidator<UpdateVocabularyModel>
{
    public UpdateVocabularyModelValidator()
    {
        RuleFor(x => x.Level)
       ...
       .NotEmpty().WithMessage(ErrorMessageBase.Required);
        ...
        {
            RuleForEach(x => x.VocabularyMeaningModels).SetValidator(new UpdateVocabularyMeaningModelValidator()!);
        });
    }
}