namespace Allen.API.Validators.Writing
{
    public class UpdateIeltsWritingModelValidator : AbstractValidator<UpdateIeltsWritingModel>
    {
        public UpdateIeltsWritingModelValidator()
        {
